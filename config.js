...
const init_phones = ["Moondrop Blessing 2 Dusk", "VitorMach Nov22 Target"],                      // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
